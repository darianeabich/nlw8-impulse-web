 ...
 return (
    <>
        ...
        <div className='flex flex-col items-center py-10 w-[304px]'>
            {/* É possível colocar imagem svg tanto importando o arquivo como imagem mesmo, na pasta assets
                OU 
                copiar o arquivo no figma como SVG e colar o texto, conforme abaixo
             */}
